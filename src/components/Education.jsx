...
const Education = () => {
    ...
    return (
        <section id="education" className="min-h-screen py-20 bg-gradient-to-br from-[#0F172A] to-[#1E293B]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-gray-300 text-lg">My academic background and professional certifications</p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    {educationList.map((edu, index) => (
                        <motion.div
                            ...
                            className="bg-gray-800/80 backdrop-blur-sm border border-gray-600 rounded-2xl p-8 shadow-xl hover:shadow-blue-500/10 transition-all duration-300"
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600">
                                    <p className="text-gray-400 text-sm mb-2">Field of Study</p>
                                    <p className="text-white font-medium">{edu.field}</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
                ...
                <div className="space-y-6">
                    ...
                    {certifications.map((cert, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.6, delay: index * 0.2 }}
                            className="bg-gray-800/80 backdrop-blur-sm border border-gray-600 rounded-2xl p-6 shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:border-blue-500/30"
                        >
