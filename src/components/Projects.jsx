        ...
        <section id="projects" className="min-h-screen py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">Showcasing my recent work and technical expertise</p>
                </motion.div>
                ...
                <div className="space-y-8">
                    {projects.map((project, index) => (
                        <motion.div
                            ...
                            className="glass bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-300 dark:border-gray-700 rounded-2xl p-8 shadow-xl hover:shadow-blue-500/10 transition-all duration-300 hover:border-blue-500/30"
                        >
